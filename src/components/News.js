...
export class News extends Component {
  ...
  static propTypes = {
    ...
    async componentDidMount(){
        ...
        let url=`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=87518db39c3e4bc0b60fca7cca74daa9&page=${this.state.page}&pageSize=${this.props.pageSize}`
